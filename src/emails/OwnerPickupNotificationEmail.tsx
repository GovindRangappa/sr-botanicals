...
type OwnerPickupNotificationEmailProps = {
  ...
  shippingCost?: number;
  total?: number;
  shippingMethod: string; // should be "Local Pickup"
};

export default function OwnerPickupNotificationEmail({
  orderId,
  customerName,
  customerEmail,
  customerPhone,
  ...
  total,
  shippingMethod,
}: OwnerPickupNotificationEmailProps) {
  return (
    <Html>
      <Head />
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Heading style={styles.heading}>New Local Pickup Order 🌿</Heading>
          ...
          <Text style={styles.footer}>
            Action needed: Please reach out to the customer to coordinate a pickup time.
          </Text>
        </Container>
      </Body>
    </Html>
